# Generated by Django 3.1.2 on 2020-10-23 06:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='accounts.customuser')),
                ('quantity', models.PositiveIntegerField(default=1, verbose_name='License Quantity')),
                ('iat', models.DateTimeField(auto_now_add=True, verbose_name='License Issued at')),
                ('eat', models.DateTimeField(blank=True, verbose_name='License Expires at')),
