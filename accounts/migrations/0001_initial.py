...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('type', models.CharField(choices=[('free', 'Free'), ('trial', 'Trial'), ('pro', 'Professional'), ('enterprise', 'Enterprise')], default='free', max_length=10, verbose_name='License Type')),
                ...
                ('iat', models.DateTimeField(auto_now_add=True, verbose_name='License Issued at')),
                ('eat', models.DateTimeField(null=True, verbose_name='License Expires at')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_license', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='profiles', to='accounts.license', verbose_name='Assigned License')),
            ],
            options={
