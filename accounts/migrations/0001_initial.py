    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_no', models.CharField(max_length=17, validators=[django.core.validators.RegexValidator(message='Invalid Phone Number', regex='^\\+(?:[0-9] ?){6,14}[0-9]$')])),
                ...
                ('license_type', models.CharField(choices=[('free', 'Free'), ('trial', 'Trial'), ('pro', 'Professional'), ('enterprise', 'Enterprise')], default='free', max_length=10, verbose_name='License Type')),
